...
<form action="kayit.php" method="POST">
    ...
    <table cellpadding="10" cellspacing="25">
        ...
        <tr>
            <td align="center" colspan="2"><button type="submit">Kayıt Ol</button></td>
        </tr>
        <tr>
            <td align="center" colspan="2">KAYIT BAŞARILI GİRİŞ YAPMAK İÇİN <b><a href="giris.php">TIKLAYINIZ</a></b>.</td>
        </tr>
    </table>
<form>
